  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={4}
        className="mt-5 short:mt-4 w-full resize-none rounded-xl border border-border bg-background px-4 py-3 text-base text-foreground placeholder:text-muted-dim focus:border-primary focus:outline-none"
      />
      {touched && !valid && (
